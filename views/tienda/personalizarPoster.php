<main>
    ...
    <div style="margin-bottom: 150px;">
        <div style="background-color: aquamarine; height: 100px;">
            <h1 style="color: black; text-align: center; padding-top: 20px;">¡Personaliza tu propio poster!
            </h1>
        </div>
        <div style="width:100%; text-align: left;">
            <form style="width: 20%; margin-left: 42%;" method="POST" action="<?=BASE_URL?>producto/addPoster">

                <br>
                <h4>Partes del poster:</h4>
                <select class="form-select" aria-label="Disabled select example" name="piezas">
                    <option value="Una pieza">1</option>
                    <option value="Dos piezas">2</option>
                    <option value="Tres piezas">3</option>
                    <option value="Cuatro piezas">4</option>
                    <option value="Cinco piezas">5</option>
                </select>
                <br>
