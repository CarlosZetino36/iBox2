<main>
     ...
     <div style="margin-bottom: 150px;">
        <div style="background-color: aquamarine; height: 100px;">
            <h1 style="color: black; text-align: center; padding-top: 20px;">¡Personaliza tu propio diseño de tazas!
            </h1>
        </div>
        <div style="width:100%; text-align: left;">
            <form style="width: 20%; margin-left: 42%;" action="<?=BASE_URL?>producto/addTaza" method="POST">
            <?php if (isset($_SESSION['taza']) && $_SESSION['taza'] = 'error'): ?>	
    <strong class="alert_red" style="color: red;"><i class="fas fa-times-circle"></i>Actualmente no contamos con este producto :(</strong><br>
    <?php endif; ?>
    <?php Utils::deleteSession('taza'); ?>    
            <br>
                <h4>Tipo de taza:</h4>
                <select class="form-select" aria-label="Disabled select example" name="tipo">
                    <option value="Normal">Taza normal</option>
