<main>
    ...
    <div style="margin-bottom: 150px;">
        <div style="background-color: aquamarine; height: 100px;">
            <h1 style="color: black; text-align: center; padding-top: 20px;">¡Personaliza tu propio diseño de pines!
            </h1>
        </div>
        <div style="width:100%; text-align: left;">
            <form style="width: 20%; margin-left: 42%;" method="POST" action="<?=BASE_URL?>producto/addPin">
            <?php if (isset($_SESSION['pin']) && $_SESSION['pin'] = 'error'): ?>	
    <strong class="alert_red" style="color: red;"><i class="fas fa-times-circle"></i>Actualmente no contamos con este producto :(</strong><br>
    <?php endif; ?>
    <?php Utils::deleteSession('pin'); ?>    
            <br>
                <h4>Tipo de pin:</h4>
                <select class="form-select" aria-label="Disabled select example" name="tipopin">
                    <option value="Metálico">Pin metálico</option>
                    <option value="Acrílico">Pin acrílico</option>
                </select>
                <br>
                ...
                <br>
                <h4>Cantidad</h4>
                <input id="numero" type="number" min="1" name="cantidad" pattern="^[0-9]+" value="1"> <br><br>
                <br>
